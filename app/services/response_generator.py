...
class DynamicResponseGenerator:
    ...
    async def generate_response_with_sql(
        ...
        """DEPRECATED: This method is dead code - not called from any active runtime path.
        
        The main SQL query flow goes through:
            session_query_handler.py → build_data_query_response → plan-first pipeline
        
        DO NOT USE. Left for backward compatibility reference only.
        Scheduled for removal in next major version.
        """
        import warnings
        warnings.warn(
            "generate_response_with_sql is deprecated. "
            "Use SemanticQueryOrchestrator → QueryPlan → query_plan_compiler pipeline instead.",
            DeprecationWarning,
            stacklevel=2
        )
        raise NotImplementedError(
            "generate_response_with_sql has been deprecated. "
            "The canonical pipeline is: SemanticQueryOrchestrator → QueryPlan → query_plan_compiler. "
    ...
    async def generate_response_with_context(
        ...
        The main query flow goes through:
            session_query_handler.py → SemanticRoutingIntegration → build_data_query_response
        ...
        import warnings
        warnings.warn(
            "generate_response_with_context is deprecated. "
            "Use session_query_handler.py → SemanticRoutingIntegration → build_data_query_response instead.",
            DeprecationWarning,
            stacklevel=2
        )
        raise NotImplementedError(
            "generate_response_with_context has been deprecated. "
            "The canonical pipeline is: session_query_handler.py → SemanticRoutingIntegration → build_data_query_response. "
            "See session_query_handler.py for the active implementation."
        )
