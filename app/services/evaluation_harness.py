...
class EvaluationHarness:
    ...
    GOLDEN_TEST_CASES: List[TestCase] = [
        TestCase(
            ...
            expected_sql_pattern=r"SELECT \* FROM.*customers",
        ...
        TestCase(
            ...
            user_query="get all unique card networks",
        ...
        TestCase(
            ...
            user_query="show me all debit cards",
            expected_tables=["cards"],
        ...
        TestCase(
            ...
            user_query="get top 10 customers by balance",
            expected_tables=["customers"],
        ...
        TestCase(
            ...
            user_query="show customers and their account balances",
        ...
        TestCase(
            ...
            user_query="show active debit cards from accounts in New York",
        ...
        TestCase(
            ...
            user_query="show customers sorted by account balance desc",
            expected_tables=["customers"],
